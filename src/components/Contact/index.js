            ...
            <section>
                ...
                <div className="bg-custom">
                    <div className="container" id="contact">
                        <h2 className="text-center py-5 display-4">Contact</h2>
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-6 col-sm-12">
                                    ...
                                    <div className="d-flex justify-content-center">
                                        <p><a href="https://github.com/kdombrosky" target="_blank" rel="noreferrer">
                                            <i className="fab fa-github-square fa-5x text-custom mx-2"></i>
                                        </a></p>
                                        <p><a href="https://www.linkedin.com/in/kdombrosky/" target="_blank" rel="noreferrer">
                                            <i className="fab fa-linkedin fa-5x text-custom mx-2"></i>
                                        </a></p>

                                        <p><a href="https://www.linkedin.com/in/kdombrosky/" target="_blank" rel="noreferrer">
                                            <i className="fab fa-twitter-square fa-5x text-custom mx-2"></i>
                                        </a></p>

                                        <p><a href="mailto:kdombroskyy@gmail.com" target="_blank" rel="noreferrer">
                                            <i className="fas fa-envelope-square fa-5x text-custom mx-2"></i>
                                        </a></p>
                                    </div>
